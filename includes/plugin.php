...
final class Plugin {
	 ...
	 * @access private
	 * @static
	 * @var \Honest_Dental_Addon\Plugin The single instance of the class.
	 */
	 ...
	 * @access public
	 * @static
	 * @return \Honest_Dental_Addon\Plugin An instance of the class.
	 */
	...
	public function custom_categories( $elements_manager ) {
		...
		$elements_manager->add_category(
			'honestdental',
			[
				'title' => esc_html__( 'Honest Dental', 'honestdental-addon' ),
				'icon' => 'fa fa-plug',
			]
		);
